---
title: Zipcodes' Distance to Fires and Acres Burned of Fires
author: Angela Zhao
date: "`r Sys.Date()`"
output: 
  github_document:
...
zipcodes_fires_ca: final tibble with all the good stuff in it. Contains zipcodes, geoid, geometry of the zipcodes, and number of fires 3, 5, 10 miles away from 2017-2019 and 2018-2019. Comes in tidy and untidy versions. 

zipcodes_fires_ca_smoke: final tibble that's zipcodes_fires_ca but filtered for the dates with data for wildfire smoke, which is from 01-2018 to 03-2019. Only comes in tidy version. 
...
### Creating new tibbles to hold mean_distance of fires intersected with zipcode, min_distance to fire, and min_acres_burned and avg_acres_burned
